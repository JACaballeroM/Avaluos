        ...
        <ContentTemplate>
            <table class="TextLeftMiddle" style="width: 100%">
                ...
                <tr>
                    ...
                    <td align="left" rowspan="2" class="style5">
                ...
                <%--        <asp:TextBox ID="txtNumeroRegistro" runat="server" 
                            Style="width: 98%" onkeyup="javascript:numeroRegistro()" onblur="javascript:eliminarBlancos(this)" Width="449px"></asp:TextBox><%--OnTextChanged="txtNumeroRegistro_TextChanged"--%>
            
                     <asp:TextBox ID="txtNumeroRegistro" runat="server" 
                        Style="width: 98%" onkeyup="javascript:numeroRegistro()" onblur="javascript:numeroRegistro();eliminarBlancos(this)" Width="449px"></asp:TextBox><%--OnTextChanged="txtNumeroRegistro_TextChanged"--%>
                   </td>
                    <td >
<%--                        <asp:RegularExpressionValidator ID="rvtxtNumeroRegistro"  runat="server" ControlToValidate="txtNumeroRegistro"
                            ValidationExpression="\s*[0-9a-zA-Z-|á|é|í|ó|ú|ñ|Ñ|Á|É|Í|Ó|Ú|]{2,}\s*" ValidationGroup="FiltroPersonas" Enabled="false">Mínimo dos carácteres</asp:RegularExpressionValidator>
                  --%> 
                                          <asp:RegularExpressionValidator ID="rvtxtNumeroRegistro"  runat="server" ControlToValidate="txtNumeroRegistro"
                            ValidationExpression=".{2,}" ValidationGroup="FiltroPersonas" Enabled="false">Mínimo dos carácteres</asp:RegularExpressionValidator>
                ...
                <tr>
                    ...
                    <td class="style5" >
                        <asp:TextBox ID="txtPeritoNombre" runat="server" Style="width: 98%" onkeyup="javascript:nombre()" onblur="javascript:nombre();eliminarBlancos(this)" ></asp:TextBox><%--OnTextChanged="txtPeritoNombre_TextChanged"--%>
                    </td>
                    <td >
...
<%--                        <asp:RegularExpressionValidator ID="rvtxtPeritoNombre" runat="server" ControlToValidate="txtPeritoNombre"
                            ValidationExpression="[0-9a-zA-Z-|á|é|í|ó|ú|ñ|Ñ|Á|É|Í|Ó|Ú|\s]* [0-9a-zA-Z-|á|é|í|ó|ú|ñ|Ñ|Á|É|Í|Ó|Ú|]{2}[0-9a-zA-Z-|á|é|í|ó|ú|ñ|Ñ|Á|É|Í|Ó|Ú|\s]*" ValidationGroup="FiltroPersonas"  Enabled="false">Mínimo dos carácteres</asp:RegularExpressionValidator>
                --%>    </td>
                </tr>
                <tr>
                    <td class="style4">
                    ...
                    <td class="style5" >
                        <asp:TextBox ID="txtPeritoApellidoPaterno" runat="server"  Style="width: 98%"
                           onkeyup="javascript:paterno()"   onblur="javascript:paterno();eliminarBlancos(this)"></asp:TextBox><%--OnTextChanged="txtPeritoApellidoPaterno_TextChanged"--%>
                    </td>
                    <td >
<%--                        <asp:RegularExpressionValidator ID="rvtxtPeritoApellidoPaterno" runat="server" ControlToValidate="txtPeritoApellidoPaterno"
                ...
                <tr>
                    ...
                    <td class="style5" >
                        <asp:TextBox ID="txtPeritoApellidoMaterno" runat="server"  Style="width: 98%" 
                              onkeyup="javascript:materno()"  onblur="javascript:materno();eliminarBlancos(this)"  > </asp:TextBox><%--OnTextChanged="txtPeritoApellidoMaterno_TextChanged"--%>
                    </td>
                    <td >
        ...
        <ContentTemplate>
            <asp:GridView ID="gridViewPersonas" runat="server" AllowPaging="True" AllowSorting="True"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="NombreCompleto" HeaderText="Apellidos y nombre" 
