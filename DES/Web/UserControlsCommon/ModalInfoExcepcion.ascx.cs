...
public partial class UserControlsCommon_ModalInfoExcepcion : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            //if (!this.Page.ClientScript.IsClientScriptIncludeRegistered("ERROR"))
            //{
            //    this.Page.ClientScript.RegisterClientScriptInclude(this.GetType(), "ERROR", this.ResolveUrl("~/ModalInfoError.aspx"));
            //}
